...
interface GuestLayoutTemplateProps {
    children: ReactNode;
...
export default function GuestLayoutTemplate({ children, navigationItems = [] }: GuestLayoutTemplateProps) {
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            >
                <div className="mx-auto flex h-16 max-w-[85rem] items-center justify-between px-4 py-10 sm:px-6 lg:px-8">
            ...
            <main className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">{children}</main>
            ...
            <footer className="mx-auto mt-auto w-full max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8">
                <div className="mb-10 grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5">
                    <div className="col-span-full hidden lg:col-span-1 lg:block">
                        ...
                        <p className="mt-3 text-xs text-gray-600 sm:text-sm dark:text-neutral-400">© 2025 Preline Labs.</p>
                    </div>
                    {/* End Col */}
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3">
                            <div className="mt-3 sm:hidden">
                                ...
                                <p className="mt-1 text-xs text-gray-600 sm:text-sm dark:text-neutral-400">© 2025 Preline Labs.</p>
                            </div>
